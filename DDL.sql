...
create table employee (
    ...
    UNIQUE(id),
	constraint login_fk_employee foreign key (email_address) references loginDetails (email_address)
...
delimiter ;
-- Error Code: 1074. Column length too big for column 'pass' (max = 255); use BLOB or TEXT instead
...
-- products
select * from product;
insert into product(id,name,price,quantity,manufacture_date,expiry_date,location,brand,category,supplier,description) values(1,"television",2000,1000,"2016-08-08","2030-09-08","Korea","SONY",1,1,"OLED television with 4k quality");
...
insert into product(id,name,price,quantity,manufacture_date,expiry_date,location,brand,category,supplier,description) values(5,"CatFoodCan",2,1000,"2018-11-11","2024-06-06","Mexico","Chewy",3,3,"Great Cat food");
...
insert  into product_sale(sale_id,product_id,quantity) values (4,1,14);
